...
void GameBoard::shuffle()
{
    ...
    do { //чтобы нормально генерировались пятнашки
...
bool GameBoard::move(int index)
{
    ...
    emit dataChanged(createIndex(0,0), createIndex(m_boardSize, 0));//сигнал вызывается, когда что-то изменяется в модели
